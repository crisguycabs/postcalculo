...
class Ui_ColParamChild(object):
    def setupUi(self, ColParamChild):
        ...
        sizePolicy.setHeightForWidth(ColParamChild.sizePolicy().hasHeightForWidth())
        ColParamChild.setSizePolicy(sizePolicy)
        ColParamChild.setMinimumSize(QtCore.QSize(565, 375))
        ColParamChild.setMaximumSize(QtCore.QSize(565, 375))
